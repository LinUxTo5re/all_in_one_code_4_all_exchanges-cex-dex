# load_markets_for_selected_exchanges() - don't call - call if you have a list of exchanges
                            ...
                            if difference_percentage_ < 50:  # market with diffr >= 50% will be ignored. those market may
                                ...
                                if not percentage_diff1 > 2 or percentage_diff1 < -2:  # ask/bid diffr must not be
                                    ...
                                    if not percentage_diff1 > 2 or percentage_diff1 < -2:
                                        ...
                                        print('Information: difference is huge b/w ask/bid price for second market. '
                                              'Ignoring.')
                                        Markets_With_Problems.append(market_)
                                else:
                                    print('Information: difference is huge b/w ask/bid price for first market. '
                                          'Ignoring.')
                                    Markets_With_Problems.append(market_)
                            else:
                ...
                for idx, exchange in enumerate(exchanges):
                    if exchange in globals():
                        try:
                            ...
                            print(f'Information: failed to fetch {MARKET} from {exchange}')
